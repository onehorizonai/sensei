...
4. If the developer cannot name the existing pattern they followed, run `/pattern-check` first.
...
```
## What changed
[One or two sentences. The WHY, not the what. Why this change now? What problem does it solve?]
...
## Risks
[What could go wrong? What edge cases were considered?
...
This section is not optional. Transparency is a professional habit.]
...
- The AI assistance section is mandatory. Hiding it is not acceptable.
